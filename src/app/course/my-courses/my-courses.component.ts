...
export class MyCoursesComponent implements OnInit {
  ...
  constructor(
    ...
    private instserve: InstructorserviceService,
    private stu: StudentserveService
  ) {}
  ...
  ngOnInit(): void {
    this.userService.userlogin().subscribe((res) => {
      this.user = res;
      if (this.user.role == 'instructor') this.getcourses(this.instructor_id);
      else this.getcoursesofstu();
    });
  ...
  getcoursesofstu() {
    this.stu.coursesofstu(this.instructor_id).subscribe((res) => {
      this.data = res;
      console.log(res);
    });
  }
  getcourses(id: number) {
    this.instserve.getone(this.instructor_id).subscribe((res) => {
      this.data = res;
    });
  }
